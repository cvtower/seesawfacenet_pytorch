...
class seesaw_Depth_Wise(Module):
     def __init__(self, in_c, out_c, residual = False, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=1, use_se = 0):
        super(seesaw_Depth_Wise, self).__init__()
        self.conv_1 = Conv_block(in_c//4, out_c=groups//4, kernel=(1, 1), padding=(0, 0), stride=(1, 1))
...
class seesaw_Residual(Module):
    def __init__(self, c, num_block, groups, kernel=(3, 3), stride=(1, 1), padding=(1, 1), use_se = 0):
        super(seesaw_Residual, self).__init__()
        modules = []
        for _ in range(num_block):
            modules.append(seesaw_Depth_Wise(c, c, residual=True, kernel=kernel, padding=padding, stride=stride, groups=groups, use_se = use_se))
...
class hyperFaceNet(Module):
    def __init__(self, embedding_size=512):
        super(hyperFaceNet, self).__init__()
        self.conv1 = Conv_block(3, 64, kernel=(3, 3), stride=(2, 2), padding=(1, 1))
        self.conv2_dw = Conv_block(64, 64, kernel=(3, 3), stride=(1, 1), padding=(1, 1), groups=64)
        self.conv_23 = seesaw_Depth_Wise(64, 64, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=128, use_se = 0)
        self.conv_3 = seesaw_Residual(64, num_block=4, groups=128, kernel=(3, 3), stride=(1, 1), padding=(1, 1), use_se = 0)
        self.conv_34 = seesaw_Depth_Wise(64, 128, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=256, use_se = 0)
        self.conv_4 = seesaw_Residual(128, num_block=6, groups=256, kernel=(3, 3), stride=(1, 1), padding=(1, 1), use_se = 0)
        self.conv_45 = seesaw_Depth_Wise(128, 128, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=512, use_se = 1)
        self.conv_5 = seesaw_Residual(128, num_block=2, groups=256, kernel=(3, 3), stride=(1, 1), padding=(1, 1), use_se = 1)
        self.conv_6_sep = Conv_block(128, 512, kernel=(1, 1), stride=(1, 1), padding=(0, 0))
        self.conv_6_dw = Linear_block(512, 512, groups=512, kernel=(7,7), stride=(1, 1), padding=(0, 0))
        self.conv_6_flatten = Flatten()
        self.linear = Linear(512, embedding_size, bias=False)
